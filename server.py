...
STEM_MAJOR_KEYWORDS = [
    ...
    "核工程", "兵器", "弹药", "探测制导", "网络空间安全", "区块链",
    # 理学类
    "物理学", "应用物理", "化学", "应用化学", "数学与应用数学",
    "信息与计算", "统计学", "应用统计", "生态学", "地理信息",
    # 农学类
    "农学", "植物", "动物", "水产", "草业", "园艺", "林学",
    "畜牧", "兽医", "烟草", "茶学", "蚕学", "种子",
    # 医学/药学类（需化学/生物）
    "临床", "口腔", "基础医学", "预防医学", "法医学", "医学检验",
    "医学影像", "眼视光", "麻醉学", "放射", "药学", "药物",
    "中药学", "制药", "生物制药", "卫生检验",
]
# 如果专业名包含以下关键词，大概率是文科/文理兼收，历史类用户放行
LIBERAL_ARTS_MAJOR_KEYWORDS = [
    # 法学类
    "法学", "法律", "知识产权", "社会工作", "社会学", "监狱学",
    # 新闻传播类
    "新闻", "传播", "广告", "编辑", "出版", "网络与新媒体",
    "广播电视编导", "戏剧影视文学",
    # 语言类
    "汉语言", "汉语", "中国语言", "古典文献",
    "英语", "日语", "俄语", "德语", "法语", "韩语", "泰语", "越南语",
    "西班牙语", "葡萄牙语", "阿拉伯语", "意大利语", "朝鲜语",
    "翻译", "商务英语", "外国语言",
    # 历史哲学类
    "历史", "考古", "文物", "哲学", "宗教", "逻辑",
    # 政治管理类
